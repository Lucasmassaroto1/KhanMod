...
ocument.querySelector("link[rel~='icon']").href = "https://r2.e-z.host/4d0a0bea-60f8-44d6-9e74-3032a64a9f32/ukh0rq22.png";
...
async function showSplashScreen(){
    ...
    splashScreen.innerHTML = '<span style="color:white;">KHAN</span><span style="color:#72ff72;">.MOD</span>';
...
function setupMain(){
    ...
    (function () {
    const phrases =[
        "🔥 Get good, get [KahnMod](https://github.com/Lucasmassaroto1/KhanMod)!",
        "☄️ By [Lucasmassaroto1/KhanMod](https://github.com/Lucasmassaroto1/KhanMod).",
        "🌟 Star the project on [GitHub](https://github.com/Lucasmassaroto1/KhanMod)!",
...
loadScript("https://cdn.jsdelivr.net/npm/toastify-js", "toastifyPlugin").then(
    async () =>{
    sendToast("🪶 KhanMode Minimal injetado com sucesso!");
